...
def hexdump(src, length=16):
    result = []
    digits = 4 if isinstance(src, unicodedata) else 2
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    # receiving data from the remote end if necessary:
    if receive_first:
    ...
    while True:
        ...
        if len(local_buffer):
            ...
            # if no more data on either side, close it.
